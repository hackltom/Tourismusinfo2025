...
function exp_label_RuhigeGebieteinsterreich_2_eval_expression(context) {
    // Kategorie || '\n' || Name

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('Kategorie')  + '\n') + feature.get('Name') );
    } else {
        return ((feature.get('Kategorie')  + '\n') + feature.get('Name') );
    }
}
...
function exp_label_SehenswrdigkeitensterreichNatur_3_eval_expression(context) {
    // Kategorie || '\n' || Name
...
function exp_label_NaturerlebnissesterreichJuni2025_4_eval_expression(context) {
    // Kategorie || '\n' || Name
